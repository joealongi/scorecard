...
### Clubhouse (Spring Boot)
GET /
GET /scorecard/{userId}
GET /scorecard/{userId}/{timestamp}
POST /scorecard/
DELETE /scorecard/{scorecardId}
GET /coursecard/
POST /coursecard/
DELETE /coursecard/{coursecardId}
GET /user/{userId}
POST /user/
DELETE /user/{userId}
GET /leadercard/
GET /leadercard/{amount}
### Course (Express)
GET /
POST /get
POST /post
...
###### Authenticated routing signout working

###### User rank should always be greater than 0

###### When switching between cards, the data should be cleared
